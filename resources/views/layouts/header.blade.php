...
<header class="limoking-header-wrapper header-style-3-wrapper limoking-header-no-top-bar">
   ...
   <div class="limoking-logo-wrapper">
      <div class="limoking-logo-container container">
         <!-- logo -->
         <div class="limoking-logo" style="margin: 10px">
            <div class="limoking-logo-inner">
               <img src="{{asset('/uploads/Logo/Milele Limousine - Web 1.png')}}" alt=""  />
            </div>
         ...
         <div class="limoking-logo-right-text " style="padding-bottom: 10px">
             <i class="fa fa-envelope" style="vertical-align: middle;color: #FFFFFF"> </i>
...
{{--             <span class="limoking-space" style="margin-top: 12px; display: block;"></span>--}}
          ...
          <div class="limoking-logo-right-text pb-10">
              <i class="fa fa-phone" style="vertical-align: middle;color: #FFFFFF"> </i>
              <span style="color: #ffffff; margin-left: 11px; font-size: 15px; line-height: 1.1;">(+971)-333-333333</span>
          </div>
         ...
         <div class="clear"></div>
          ...
          <div class="limoking-header-container container">
              ...
              <div class="limoking-navigation-wrapper" style="margin-top: 0px;height: 50px">
...
{{--      <div class="limoking-header-container container">--}}
{{--         <div class="limoking-header-inner-overlay"></div>--}}
{{--         <div class="limoking-navigation-wrapper" style="margin-top: 0px">--}}
{{--            <nav class="limoking-navigation" id="limoking-main-navigation" >--}}
{{--               <ul id="menu-main-menu-1" class="sf-menu limoking-main-menu">--}}
{{--                  <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-5702 current_page_item menu-item-6241menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-5702 current_page_item menu-item-6241 limoking-normal-menu"><a href="{{route('home')}}">Home</a></li>--}}
{{--                  <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6242menu-item menu-item-type-post_type menu-item-object-page menu-item-6242 limoking-normal-menu"><a href="{{route('aboutUs')}}">About Us</a></li>--}}
